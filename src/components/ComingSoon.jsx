...
function ComingSoon() {
  return (
    <div className='bg-black mt-10 px-10 py-10'>
      <div className="bg-black text-white text-left pl-16 pt-10">
        <h2 className="text-3xl font-bold mt-5 md:ml-8 mb-[-30px]">Coming Soon</h2>
      </div>
      <div className="bg-black text-white text-center md:px-8 lg:px-12 grid md:grid-cols-2 gap-8">
        <div className="grid grid-cols-1 grid-rows-2 gap-6 md:gap-4 py-20  h-[1080px] ml-4 sm:ml-10 px-6 md:px-2">
        ...
        <div className="grid grid-cols-1 grid-rows-3 h-[1080px] py-20 gap-6 md:gap-4 mr-4 sm:mr-10 px-6 md:px-2">
          <div className="relative">
            <img
              src={fifa23}
              alt="Coming Soon 3"
